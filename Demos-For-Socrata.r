...
#run Spatial-OPA.r (available on the cno-opa github)
packages = "C:\\RWorkingDir\\RPackages" #package library			             
.libPaths(packages)
...
# Export
exp.name <- paste0(demo.name, "-for-Socrata.csv") 
write.csv(demos, exp.name) 
