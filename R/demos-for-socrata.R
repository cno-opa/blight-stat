...
demos <- cbind(demos, demo.coords) # this may duplicate the coords.x1 (X/long) and coords.x2 (Y/lat) columns, but better to have too many coordinates than not enough
demos[is.na(demos)] <- ""
